...
var serviceTaskDelegateProps = require('./parts/ServiceTaskDelegateProps'),
    ...
    approverProps = require('./parts/ApproverProps'),
    knowledgeProps = require('./parts/KnowledgeProps'),
    relatedSystemsProps = require('./parts/RelatedSystemsProps'),
    ...
    simpleCallActivityProps = require('./parts/SimpleCallActivityProps'),
...
function createGeneralTabGroups(element, bpmnFactory, elementRegistry, elementTemplates) {
  ...
  if (window.pal.consumer == 'hwenc') {
    approverProps(detailsGroup, element);
    relatedSystemsProps(detailsGroup, element);
  }
  ...
  simpleCallActivityProps(detailsGroup, element);
  ...
  knowledgeProps(documentationGroup, element, bpmnFactory);
